...
@php
    ...
    $field['placeholder'] = $field['placeholder'] ?? 'Select Citizen Profile';
...
@include('crud::fields.inc.wrapper_start')
    ...
    <select
        name="{{ $field['name'] }}"
        style="width: 100%"
        data-init-function="bpFieldInitCitizenProfileSelectionInputElement"
...
@push('crud_fields_scripts')
@loadOnce('bpFieldInitCitizenProfileSelectionInputElement')
<script>
    function bpFieldInitCitizenProfileSelectionInputElement(element) {
        ...
        $(element).select2({
            theme: 'bootstrap',
            multiple: false,
            placeholder: 'Select Citizen Profile',
