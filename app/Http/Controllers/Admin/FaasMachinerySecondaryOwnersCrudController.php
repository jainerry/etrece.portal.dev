...
use App\Http\Requests\FaasMachinerySecondaryOwnersRequest;
use Backpack\CRUD\app\Http\Controllers\CrudController;
use Backpack\CRUD\app\Library\CrudPanel\CrudPanelFacade as CRUD;

/**
 * Class FaasMachinerySecondaryOwnersCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class FaasMachinerySecondaryOwnersCrudController extends CrudController
{
    ...
    {
        CRUD::setValidation(FaasMachinerySecondaryOwnersRequest::class);
