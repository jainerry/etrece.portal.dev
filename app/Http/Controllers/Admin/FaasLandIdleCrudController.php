...
use App\Http\Requests\FaasLandIdleRequest;
...
/**
 * Class FaasLandIdleCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class FaasLandIdleCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\FaasLandIdle::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/faas-land-idle');
        //CRUD::setEntityNameStrings('faas land idle', 'faas land idles');
        CRUD::setEntityNameStrings('idle land ', 'idle lands');
    }
    ...
    {
        CRUD::setValidation(FaasLandIdleRequest::class);
        ...
        $this->crud->addField([   // n-n relationship
            'name' => 'land_idle_owner', // JSON variable name
        ...
        FaasLandIdle::creating(function($entry) {
            $count = FaasLandIdle::select(DB::raw('count(*) as count'))->where('ARPNo','like',"%".Date('mdY')."%")->first();
    ...
    public function create()
    {
        ...
        return view('faas_land_idle.create', $this->data);
    }
