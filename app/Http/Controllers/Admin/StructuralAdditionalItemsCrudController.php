...
use App\Http\Requests\StructuralAdditionalItemsRequest;
use Backpack\CRUD\app\Http\Controllers\CrudController;
use Backpack\CRUD\app\Library\CrudPanel\CrudPanelFacade as CRUD;

/**
 * Class StructuralAdditionalItemsCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class StructuralAdditionalItemsCrudController extends CrudController
{
    ...
    {
        CRUD::setValidation(StructuralAdditionalItemsRequest::class);
