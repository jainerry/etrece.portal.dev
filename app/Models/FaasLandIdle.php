...
class FaasLandIdle extends Model
{
    use CrudTrait;
    ...
    */
    ...
    protected $table = 'faas_land_idles';
    ...
    */
    ...
    public function land_idle_owner(){
        return $this->belongsToMany(CitizenProfile::class,'faas_land_idle_secondary_owners','citizen_profile_id','land_idle_profile_id');
    }
    ...
    */
    ...
    public function setLandSketchAttribute($value)
    {
        ...
        $destination_path = "public/uploads/images/faas_land_idle/land-sketches";
